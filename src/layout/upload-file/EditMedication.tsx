...
export const EditMedication: React.FC<EditFormProps> = (data) => {
    console.log(data);
            ...
            {data ?
                (<form className='font-medium pb-8'>
                    <div className="relative z-0 w-full mb-6 group">
                        ...
                        <input type="text" name="repeat_password" id="floating_repeat_password" className="block py-2.5 w-full text-sm text-gray-900" placeholder=" " required value={data.data.name} />
                    </div>
                    ...
                    <div className="grid md:grid-cols-5 md:gap-4">
                        ...
                        <div className="relative z-0 w-full group col-span-1 gap-2 flex items-center">
                            <div className="flex items-center gap-1">
                                <input type="radio" className="border-red-500" name="repeat_password" id="floating_repeat_password" placeholder="" required value="YES" checked={data.data.name === "YES"} />
                                <label htmlFor="floating_repeat_password">YES</label>
                            </div>
                            <div className="flex items-center gap-1">
                                <input type="radio" className="border-red-500" name="repeat_password" id="floating_repeat_password" placeholder="" required value="NO" checked={data.data.name === "NO"} />
